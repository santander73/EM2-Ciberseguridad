...
![Banner de Ciberseguridad](img/estructura.png)
...
- **`amenazas.html`**: Dedicada a explorar las amenazas cibernéticas más comunes, como _phishing_, _ransomware_, _malware_ y ataques DDoS. Incluye secciones interactivas y un carrusel de ejemplos reales.
...
Si tienes alguna pregunta o sugerencia, no dudes en contactarme a través de [tu-email@ejemplo.com](mailto:tu-email@ejemplo.com) o abriendo una _issue_ en este repositorio.
